              ...
              <form action='{{ route('client.update',$data->id) }}' method='POST' enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="last_name" class="form-control" id="last_name" name='last_name' placeholder="Enter last name" value='{{ $data->last_name }}'>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone" name='phone' placeholder="+9574535297" value='{{ $data->phone }}'>
